...
* CS11-20字段，会迁移至“[用户变量](../../implementation/shi-jian-ji-bian-liang/zi-ding-yi-bian-liang/ge-lei-xing-zi-ding-yi-bian-liang-jie-shao/yong-hu-bian-liang.md)”。两者的区别主要在于：用户变量支持自定义的归因方式。
...
类似于用户属性字段，在 2.x 版本中，页面属性字段被迁移到了[“页面级变量”](../../implementation/shi-jian-ji-bian-liang/zi-ding-yi-bian-liang/ge-lei-xing-zi-ding-yi-bian-liang-jie-shao/ye-mian-ji-bian-liang.md)。与页面属性字段不同的是，**页面级变量相当于过去的 PS 字段，不再存在过去的 PG 字段**。
