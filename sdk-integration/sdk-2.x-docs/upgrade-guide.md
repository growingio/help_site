...
* CS11-20字段，会迁移至“[用户变量](../../implementation/event-variable/custom-event/custom-variables-introduction/user-variable.md)”。两者的区别主要在于：用户变量支持自定义的归因方式。
...
对 Web 端的开发者，GrowingIO 提供了 Chrome 浏览器插件形式的 debug 工具，请在[这里](../web-debugger/web-debugger-install.md)下载安装。
