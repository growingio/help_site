...
详细更新：
1. 可以指定目标用户群体进行留存分析，目标人群支持 4 个 segmentation+ 用户自定义分群
2. 可以对起始行为和留存行为分别加过滤条件
3. 增加了对打点事件的支持
4. 任意行为支持区分不同平台，一个项目下有多个平台可以分别查看
5. 起始行为对比：
...
6. 支持留存行为对比：同一个起始行为在不同留存行为上的对比
7. 『天』颗粒度的留存最多支持到 90 天，原来是 30 天
8. 留存表数据支持下载
9. 新增功能模块：用户可以切换至『留存率趋势』视图，查看留存率趋势
10. 在留存率基础上，留存表中提供了留存人数数据
11. 增加了留存的权限设定
用户体验优化：
* 可用事件限定
* 可用事件和过滤条件之间的限定
...
* 新版SDK安卓最新版0.8.52    <br />
  ...
  * 恢复了定义页面标签。
  * 对于已经集成过SDK的产品，需要重新集成最新SDK，并重新发版，才能在App内圈选H5。 <br />
* iOS最新版0.9.8.1  <br />
  * 改进App定义标签界面UI，美观度大大提高。
  * 改进App圈选交互，结合使用场景判断默认参数。
  * 恢复了定义页面标签。  <br />
* 首页改版 <br />
  * GrowingIO首页全新改版，颜值变高的同时，我们也为我们的技术博客做了升级，加入了更多有关数据分析与增长黑客的精选内容，能帮你快速掌握精细化运营的精髓4. 新版帮助中心  <br />
* 帮助文档<br />
  * 首页改版的同时，我们也一并推出了新的帮助中心。所有你想要的帮助文档、开发者文档、使用GrowingIO产品使用手册、数据字典以及FAQ通通都在这  <br />
* 用户分群下载<br />
